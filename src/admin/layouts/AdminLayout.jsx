...
export default function AdminLayout({ children }) {
  ...
  const links=[['/admin/dashboard','📊 Dashboard'],['/admin/courses','🎓 Courses'],['/admin/posts','📝 Posts'],['/admin/pages','📄 Pages'],['/admin/seo','🔎 SEO'],['/admin/users','👨‍🎓 Students'],['/admin/demo-registrations','👥 Demo Registrations'],['/admin/analytics','📈 Analytics']];
